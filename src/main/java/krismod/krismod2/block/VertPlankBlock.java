...
public class VertPlankBlock extends FacingBlock implements BlockEntityProvider {
    public VertPlankBlock() { super(Settings.create().nonOpaque());}

    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return BlockEntityRegistry.VERT_WOOD_PLANKS.instantiate(pos, state);
    }
    ...
    public void appendTooltip(ItemStack stack, BlockView blockGetter, List<Text> tooltip, TooltipContext tooltipFlag) {
        tooltip.add(Text.translatable("block." + Krismod2.MOD_ID + ".vert-wood-block.tooltip"));
